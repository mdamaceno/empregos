...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            <form method="POST" id="candidates_selection" action="admin" class="form-horizontal">
                ...
                <div class="form-group pull-right">
                    ...
                    <div class="col-sm-7">
                        <select name="opt_user" class="form-control" id="function">
                            ...
                            <option value="207" ${filterSelected == 207 ? 'selected' : ''}>Webdesigner</option>
                        </select>
                    </div>
                </div>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="admin">
                                    ...
                                    <button type="submit" class="btn btn-xs btn-primary">Agendar</button>
                                </form>
                            </td>
                        </tr>
                    </c:if>
...
<script>
    $(document).ready(function () {
        $("#function").on("click", function () {
            $('form#candidates_selection').submit();
        });
    });
</script>